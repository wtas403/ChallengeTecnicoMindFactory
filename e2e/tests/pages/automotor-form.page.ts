...
export class AutomotorFormPage {
  ...
  async fillDraft(draft: AutomotorDraft): Promise<void> {
    ...
    await this.page
      .locator("#automotor-form-fecha-fabricacion")
      .fill(draft.fechaFabricacion);
    await this.page
      .locator("#automotor-form-cuit-titular")
      .fill(draft.cuitTitular);
  }
  ...
  async fillEditFields(fields: {
    ...
    if (fields.fechaFabricacion !== undefined) {
      await this.page
        .locator("#automotor-form-fecha-fabricacion")
        .fill(fields.fechaFabricacion);
    }

    if (fields.cuitTitular !== undefined) {
      await this.page
        .locator("#automotor-form-cuit-titular")
        .fill(fields.cuitTitular);
    }
  }
  ...
  async confirmSubmit(): Promise<void> {
    await expect(
      this.page.locator("#automotor-create-confirmation-dialog"),
    ).toBeVisible();
